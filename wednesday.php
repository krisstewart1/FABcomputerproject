...
<html>
<h1>Wednesday Work sheet</h1>
<div><button onClick="window.print()">Print this page
    </button></div>
<div class="article-container">
    <div class="results">
        <?php
        $sql = "SELECT * FROM orders INNER JOIN customer ON orders.c_id = customer.c_id WHERE c_binday='wednesday' AND orders_edate >= CURDATE() AND orders_sdate <= CURDATE() ;";

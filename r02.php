...
<body>
    ...
    <div class="paypalbutton">
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            ...
            <input type="hidden" name="hosted_button_id" value="R6UAL5T7VJ738">
            <table>
                <tr>
                ...
                <tr>
                    <td><select name="os0">
                            <option value="Weekly Bin Clean">Weekly Bin Clean : £28.00 GBP - monthly</option>
                        </select> </td>
                </tr>
                <tr>

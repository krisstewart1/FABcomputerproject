...
<body>
    <h1>Do you have multiple bins?</h1>
    ...
    <div class="paypalbutton">
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            ...
            <input type="hidden" name="hosted_button_id" value="5LJ869CLUKPFE">
            <table>
                <tr>
                ...
                <tr>
                    <td><select name="os0">
                            <option value="2 Bins">2 Bins £29.00 GBP</option>
                            <option value="3 Bins">3 Bins £43.00 GBP</option>
                            <option value="4 Bins">4 Bins £57.00 GBP</option>
                        </select> </td>
                </tr>
                <tr>

...
<body>
    <h1>Multiple commercial bins</h1>
    ...
    <div class="paypalbutton">
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            ...
            <input type="hidden" name="hosted_button_id" value="UR69E6VNUMWU2">
            <table>
                <tr>
                ...
                <tr>
                    <td><select name="os0">
                            <option value="2 Bins">2 Bins : £76.00 GBP - monthly</option>
                            <option value="3 Bins">3 Bins : £112.00 GBP - monthly</option>
                            <option value="4 Bins">4 Bins : £144.00 GBP - monthly</option>
                        </select> </td>
                </tr>
                <tr>
